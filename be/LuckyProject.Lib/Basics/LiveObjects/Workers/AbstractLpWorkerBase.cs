...
namespace LuckyProject.Lib.Basics.LiveObjects.Workers
{
    ...
    /// </summary>
    public abstract class AbstractLpWorkerBase
    {
        #region Internals
        ...
        protected bool IsStopBaseRequested() => stopCts.IsCancellationRequested;
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            timeout ??= TimeoutDeafults.Infinity;
        ...
        protected async Task<(bool Succeded, int ExitCode)> JoinBaseAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            singleCheckTimeout ??= TimeoutDeafults.Short;
            delayTimeout ??= TimeoutDeafults.Shortest;
            totalTimeout ??= TimeoutDeafults.Infinity;
