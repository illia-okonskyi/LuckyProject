...
{
    /// <summary>
    /// Default timeouts are <see cref="TimeoutDeafults.Infinity"/>, spin wait timeout is
    /// <see cref="TimeoutDeafults.Shortest"/>
    /// </summary>
    public static class ThreadSyncHelper
    {
        #region Internals
        private static Task<bool> SpinWaiter(TimeSpan? ts, CancellationToken ct) =>
            TaskHelper.SafeDelay(ts ?? TimeoutDeafults.Shortest, ct);
        #endregion
